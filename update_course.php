...
if (isset($_POST['save'])) {
    ...
    $updateSuccess = $con->updateCourse($course_id, $course_name);
...
<body class="bg-light">
  <div class="container py-5">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="course_id" value="<?php echo $course_data['course_id'] ?>" id="course_id" class="form-control" disabled required>
      </div>
